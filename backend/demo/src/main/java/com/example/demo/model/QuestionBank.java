...
public class QuestionBank {
    ...
    private void buildSweQuestions() {
        questions.add(q("swe-e1", "Two Sum", Difficulty.EASY,
        ...
        questions.add(q("swe-e2", "Valid Parentheses", Difficulty.EASY,
        ...
        questions.add(q("swe-m1", "Binary Tree Level Order Traversal", Difficulty.MEDIUM,
        ...
        questions.add(q("swe-m2", "Number of Islands", Difficulty.MEDIUM,
        ...
        questions.add(q("swe-h1", "Word Break II", Difficulty.HARD,
    ...
    private void buildCloudQuestions() {
        questions.add(q("cld-e1", "Design HashMap", Difficulty.EASY,
        ...
        questions.add(q("cld-e2", "Number of Recent Calls", Difficulty.EASY,
        ...
        questions.add(q("cld-m1", "Meeting Rooms II", Difficulty.MEDIUM,
        ...
        questions.add(q("cld-m2", "Task Scheduler", Difficulty.MEDIUM,
        ...
        questions.add(q("cld-h1", "LRU Cache", Difficulty.HARD,
    ...
    private void buildMlQuestions() {
        questions.add(q("ml-e1", "Running Sum of 1D Array", Difficulty.EASY,
        ...
        questions.add(q("ml-e2", "Find Smallest Letter Greater Than Target", Difficulty.EASY,
        ...
        questions.add(q("ml-m1", "Maximum Subarray", Difficulty.MEDIUM,
        ...
        questions.add(q("ml-m2", "Count of Smaller Numbers After Self", Difficulty.MEDIUM,
        ...
        questions.add(q("ml-h1", "Longest Increasing Subsequence", Difficulty.HARD,
